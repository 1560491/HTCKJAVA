...
//Phần Header
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						...
						<a class="active" href="std-page.jsp?pgprt=1"><h2>Bài Thi</h2></a>
    ...
    document.getElementById("remainingTime").innerHTML =  time+" : "+sec;
       // Đặt hàm chạy thời gian từ 1000                 
...
if(sec==0){
    ...
    time--;
           ...
           <div class="profile">
               <span class="tag">Ngày làm</span><span class="val"><%=result.getDate() %></span><br/>
               <span class="tag">Thời gian bắt đầu</span><span class="val"><%=result.getStartTime() %></span><br/>
               <span class="tag">Thời gian kết thúc</span><span class="val"><%=result.getEndTime() %></span><br/>
               <span class="tag">Bài thi</span><span class="val"><%=result.getcName() %></span><br/>
               <span class="tag">Số câu hỏi trả lời</span><span class="val"><%=result.getObtMarks() %></span><br/>
               <span class="tag">Tổng số câu hỏi</span><span class="val"><%=result.gettMarks() %></span><br/>
               <span class="tag">Kết quả</span><span class="val"><%=result.getStatus() %></span></h2>
           </div>
           <p></p>
           <p></p>
           <p></p>
        ...
        <div class="panel form-style-6" style="float: left;max-width: 900px; padding-top: 40px;">
            <div class="title" style="margin-top: -60px;">Chọn bài thi để làm</div>
       <br/>
