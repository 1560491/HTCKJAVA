...
<body>
	<div class="top-area">
		<center><h2>Trang Học Sinh</h2></center> <a href="controller.jsp?page=logout" class="button" style="float: right;background:crimson;color:white">ĐĂNG XUẤT</a>
	</div>
    ...
    <%
           ...
           if(session.getAttribute("userStatus").equals("1")){
            ...
            <a href="controller.jsp?page=logout" class="button" style="float: right;background:crimson;color:white">ĐĂNG XUẤT</a>
            </div>
            <% 
