//Trang trung gian điều hướng xuống DB
...
response.setCharacterEncoding(“UTF-8”);
 // Nếu parameter nó được nhận có label là login thì kiểm tra ở session và quăng xuống 
<%
...
// Điều hướng đến xử lý sửa thông tin cá nhân
    ...
    response.sendRedirect("dashboard.jsp");
    ////////////////////////////////////////////////////////////////////////////
    // Đến DB cập nhật câu hỏi
}else if(request.getParameter("page").toString().equals("answerUpdate")){
        int aId=Integer.parseInt(request.getParameter("answer_id"));        
        String answer =request.getParameter("answer"); 
        int eId=Integer.parseInt(request.getParameter("exam_id"));        

    pDAO.updateAnswers(aId, answer);
    response.sendRedirect("std-page.jsp?pgprt=2&eid="+eId);
//////////////////////////////////////////////////////////////////  Xoa cau hoi  
